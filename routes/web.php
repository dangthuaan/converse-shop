...
Route::middleware(['auth', 'verified', 'is-ban'])
    ...
    ->group(function () {
        ...
        Route::post('orders/plusQuantity', 'OrderController@increaseQuantity')->name('orders.increaseQuantity');
        Route::post('orders/minusQuantity', 'OrderController@decreaseQuantity')->name('orders.decreaseQuantity');
